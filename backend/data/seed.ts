...
async function main() {
  const cabanaShelter = await prisma.createProduct({
    brand: 'Kelty',
  ...
  const bigAgnes = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Big Agnes',
  ...
  const halfDome2PlusTent = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'REI Co-op',
  ...
  const Kingdom6Tent = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'REI Co-op',
  ...
  const Assault2Tent = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
  ...
  const BattleMountain2Tent = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Big Agnes',
  ...
  const TigerWallUL2Tent = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Big Agnes',
  ...
  const Catalyst2PTentWithFootprint = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Marmot',
  ...
  const Talus2TentWithFootprint = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'The North Face',
  ...
  const CosmicDown40SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Kelty',
  ...
  const AtomSleepingBags = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Marmot',
  ...
  const Furnace20SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'The North Face',
  ...
  const Riff15SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'NEMO',
  ...
  const Magma10SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'REI Co-op',
  ...
  const Trestles0SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Marmot',
  ...
  const CosmicDown20SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Kelty',
  ...
  const Siesta30SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'REI Co-op',
  ...
  const Disco15SleepingBag = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'NEMO',
  ...
  const MantaAG36HydrationPack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Osprey',
  ...
  const Graviton34Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Marmot',
  ...
  const Talon6HydrationWaistpack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Osprey',
  ...
  const Kyte46Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Osprey',
  ...
  const Trekker65Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Kelty',
  ...
  const KidComfortAirChildCarrier = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Deuter',
  ...
  const AtmosAG65Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Osprey',
  ...
  const Baltoro65Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'Gregory',
  ...
  const Traverse65Pack = await prisma.product.upsert({
    where: {},
    update: {},
    create: {
      brand: 'REI Co-op',
  ...
  console.log({ cabanaShelter, bigAgnes, halfDome2PlusTent, Kingdom6Tent, Assault2Tent, BattleMountain2Tent, TigerWallUL2Tent, Catalyst2PTentWithFootprint, Talus2TentWithFootprint, CosmicDown40SleepingBag, AtomSleepingBags, Furnace20SleepingBag, Riff15SleepingBag, Magma10SleepingBag, Trestles0SleepingBag, CosmicDown20SleepingBag, Siesta30SleepingBag, Disco15SleepingBag, MantaAG36HydrationPack, Graviton34Pack, Talon6HydrationWaistpack, Kyte46Pack, Trekker65Pack, KidComfortAirChildCarrier, AtmosAG65Pack, Baltoro65Pack, Traverse65Pack })
}
